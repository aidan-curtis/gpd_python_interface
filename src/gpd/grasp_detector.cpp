...
std::vector<std::unique_ptr<candidate::Hand>> GraspDetector::procGrasps(
  ...
  std::string filename = "/home/aidan/ManiSkill/temp/grasps.txt";
  std::ofstream myfile;
...
std::string GraspDetector::vectorToString(const Eigen::VectorXd &v) const {
  std::string s = "";
